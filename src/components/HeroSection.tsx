      ...
      >
        ...
        <div className="relative w-[100vw] h-[56.25vw] min-h-full min-w-[177.78vh] overflow-hidden">
          <iframe
            ...
            className="w-full h-full filter brightness-[0.75] contrast-[1.05]"
          />
        </div>
      </motion.div>

      {/* Cinematic Vignette & Dark Gradient Mask matching #000c0d */}
      <div className="absolute inset-0 vignette-overlay pointer-events-none" />
      <div className="absolute inset-0 bg-gradient-to-t from-[#000c0d] via-transparent to-[#000c0d]/70 pointer-events-none" />
